...
const portfolioData = {
  ...
  experience: [
    {
      id: 1,
      position: "Independent iOS Developer",
      company: "Self-Employed — Remote",
      period: "Jan 2025 - Present",
      description: [
        "Shipped 14 native iOS apps to the App Store, reaching over 10,000 downloads and maintaining a 4.6 average rating",
        ...
        "Monetized apps through subscriptions and in-app purchases, generating over $1000 of monthly recurring revenue"
      ],
